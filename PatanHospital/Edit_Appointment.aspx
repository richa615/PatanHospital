<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="Edit_Appointment.aspx.cs" Inherits="PatanHospital.Edit_Appointment" %>
...
<body>
    ...
    <div>
        ...
        <tr class="HeaderStyle">
        <th class="auto-style1" colspan="5">Editing The Appointment Schedules by the Administrator</th>
        </tr>
        <tr class="HeaderStyle">
        <th class="auto-style1">&nbsp;</th>
        <th style="width:200px">&nbsp;</th>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            CssClass="GridViewStyle" GridLines="Both" Width="650px" ShowHeader="True">
            <Columns>
                ...
                <asp:BoundField DataField="End_Time" HeaderText="End Time" ItemStyle-Width="100px" SortExpression="End_Time"/>
                <asp:BoundField DataField="PName" HeaderText="Patient Name" ItemStyle-Width="125px" ReadOnly="True" SortExpression="PName" />
                <asp:BoundField DataField="DName" HeaderText="Doctor Name" ItemStyle-Width="125px" ReadOnly="True" SortExpression="DName" />
            </Columns>
        ...
        <asp:SqlDataSource ID="sqlDataSourceGridView" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalServerConnectionString %>" 
            SelectCommand="SELECT DoctorSchedule.Date, DoctorSchedule.Start_Time, DoctorSchedule.End_Time, PatientCredientials.Fname + ' ' + PatientCredientials.Lname AS PName, DoctorCrediantials.Fname + ' ' + DoctorCrediantials.Lname AS DName FROM DoctorCrediantials INNER JOIN DoctorSchedule ON DoctorCrediantials.SSN = DoctorSchedule.D_SSN INNER JOIN PatientCredientials ON DoctorSchedule.P_SSN = PatientCredientials.SSN" 
            FilterExpression="[PName] like '{0}%' and [Dname] like '{1}%'">
            <FilterParameters>
